...
echo "创建 tag..."
git tag -a "v$VERSION" -m "TTrans v$VERSION"
...
echo ""
echo "查看进度: https://github.com/thierrycao/TTrans/actions"
echo ""
echo "发布后:"
echo "  - PyPI: https://pypi.org/project/TTrans/"
echo "  - GitHub: https://github.com/thierrycao/TTrans/releases"